...
class NetworkReceiver():
    ...
    def __init__(self, configured_ports):
        ...
        self.configured_ports = configured_ports
    ...
    def _listen_slippi(self, parent):
        ...
        slippi_socket.bind(('', self.configured_ports['slippi']))
    ...
    def _listen_video(self, parent):
        ...
        video_socket.bind(('', self.configured_ports['video']))
        ...
        while parent._namespace.run:
            try:
                ...
                if video_parser.update(data_str):
                    ...
                    if video_captures and len(parent._receiver_list) <= 100:
