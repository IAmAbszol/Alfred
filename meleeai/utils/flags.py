...
def create_flags():
    ...
    flags.DEFINE_string('sending_ip', '127.0.0.1', 'IP address to send processed controller state data to Dolphin client.')
    ...
    flags.DEFINE_integer('memorysize', 1000, 'Buffer data to hold till consumed.')
    ...
    flags.DEFINE_integer('alfred_port', 0, 'Alfred port that\'s dedicated to the agent.')
